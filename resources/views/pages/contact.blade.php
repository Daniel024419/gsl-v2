...
@section('description', 'Get in touch with the Ghana School of Law. Office addresses, phone numbers, email, and contact
    form.')
@section('content')
    ...
    <section class="relative pt-[72px] min-h-[300px] flex items-end pb-14 px-[5%]"
        ...
        <div class="max-w-6xl mx-auto w-full">
            <p class="text-[13px] font-bold text-gold/70 tracking-[3px] uppercase mb-3">Contact Us</p>
            <h1 class="font-serif font-semibold text-white leading-[1.1] mb-4" style="font-size:clamp(32px,5vw,58px)">Get in
                <span class='text-gold'>Touch</span></h1>
    ...
    <section class="py-20 px-[5%] bg-white">
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div class="lg:col-span-3">
                <p class="text-[13px] font-bold text-gold tracking-[3px] uppercase mb-3">Send a Message</p>
                ...
                <form action="#" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-[12px] font-semibold text-gray-500 tracking-[1.5px] uppercase mb-2">First
                                Name</label>
                        ...
                        <div>
                            <label
                                class="block text-[12px] font-semibold text-gray-500 tracking-[1.5px] uppercase mb-2">Last
                                Name</label>
                    ...
                    <div>
                        <label class="block text-[12px] font-semibold text-gray-500 tracking-[1.5px] uppercase mb-2">Email
                            Address</label>
                    ...
                    <div>
                        <label
                            class="block text-[12px] font-semibold text-gray-500 tracking-[1.5px] uppercase mb-2">Subject</label>
                        <select name="subject"
                    ...
                    <div>
                        <label
                            class="block text-[12px] font-semibold text-gray-500 tracking-[1.5px] uppercase mb-2">Message</label>
            ...
            <div class="lg:col-span-2 flex flex-col gap-5">
                <div>
                    <p class="text-[13px] font-bold text-gold tracking-[3px] uppercase mb-4">Our Offices</p>
                ...
                <div class="p-5 rounded-xl bg-gold/8 border border-gold/25">
                    <p class="text-[13px] font-bold text-gold tracking-[2px] uppercase mb-2">Admissions Hotline</p>
