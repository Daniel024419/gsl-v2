...
@section('description','Get in touch with the Ghana School of Law. Office addresses, phone numbers, email, and contact form.')
@section('content')
...
<section class="relative pt-[72px] min-h-[300px] flex items-end pb-14 px-[5%]"
    ...
    <div class="max-w-6xl mx-auto w-full">
        <p class="text-[11px] font-bold text-gold/70 tracking-[3px] uppercase mb-3">Contact Us</p>
        <h1 class="font-serif font-semibold text-white leading-[1.1] mb-4" style="font-size:clamp(32px,5vw,58px)">Get in <span class='text-gold'>Touch</span></h1>
        <p class="text-[16px] text-cloud/62 max-w-xl leading-[1.7]">Our admissions and enquiries teams are ready to help. Reach us by phone, email or visit any of our three campuses.</p>
    </div>
</section>
        ...
        <div class="lg:col-span-3">
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <button type="submit"
                    ...
                    Send Message
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                </button>
            </form>
        </div>
