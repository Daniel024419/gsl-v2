...
@section('description', 'Latest news from the Ghana School of Law - institutional updates, events, and academic
    announcements.')
@section('content')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="mt-7">
                    ...
                    <div class="flex items-center gap-3.5 border-t border-white/6 pt-5">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-cloud/35 uppercase tracking-[1px] mt-0.5">January 2026 &bull; 7 Min
                                Read</p>
                        </div>
                        <a href="#"
                            class="ml-auto text-[11px] font-bold tracking-[2px] uppercase text-gold border border-gold/25 px-4 py-2 rounded hover:bg-gold/8 transition-colors">
                            READ MORE &rarr;
                        </a>
                    </div>
                </div>
            ...
            <div class="lg:col-span-4 flex flex-col gap-6">
                ...
                <div class="bg-navy p-7 border border-gold/20 rounded-xl flex flex-col items-center text-center">
                    ...
                    <p class="mt-4 text-[11px] text-cloud/30 leading-snug">By subscribing you agree to our privacy policy.
                    </p>
                </div>
                        ...
                        <article
                            ...
                            <div class="md:w-2/3 flex flex-col justify-center">
                                ...
                                <div class="flex items-center gap-4 border-t border-gray-200 pt-3">
                                    <span
                                        class="text-[11px] text-gray-400 uppercase tracking-[1px]">{{ $fa['date'] }}</span>
                                    <span
                                        class="text-[11px] text-gray-400 uppercase tracking-[1px]">{{ $fa['read'] }}</span>
                                    <a href="#"
                        ...
                        @foreach ([$articles[0], $articles[1]] as $bc)
                            <article class="group cursor-pointer">
                                <div class="w-full aspect-video rounded-lg overflow-hidden mb-4 flex items-center justify-center"
                                    ...
                                    <svg class="w-8 h-8 stroke-gold/20 fill-none" stroke-width="1" stroke-linecap="round"
                                        stroke-linejoin="round" viewBox="0 0 24 24">
                                        {!! $bc['icon'] !!}
                                    </svg>
                                </div>
                                ...
                                <p class="mt-2 text-[13px] text-gray-500 leading-[1.65] line-clamp-2">{{ $bc['excerpt'] }}
                                </p>
                                <div class="mt-3 flex items-center justify-between">
                                    <span class="text-[11px] text-gray-400 uppercase tracking-[1px]">{{ $bc['date'] }}
                                        &bull; {{ $bc['read'] }}</span>
                                    <a href="#"
